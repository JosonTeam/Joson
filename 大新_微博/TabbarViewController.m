...
#pragma mark 获取当前用户的用户名
    ...
    NSArray * highLight = @[@"tabbar_home_highlighted@2x.png" , @"tabbar_message_center_highlighted@2x.png" , @"" , @"tabbar_discover_highlighted@2x.png" , @"tabbar_profile_highlighted@2x.png"];
