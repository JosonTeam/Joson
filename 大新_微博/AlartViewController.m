...
- (void)viewDidLoad
{
    ...
    [positiveView setBackgroundColor:[UIColor colorWithRed:0.20
                                                     green:0.28
                                                      blue:0.41
                                                     alpha:1]];
    ...
    [negativeView setBackgroundColor : [UIColor colorWithRed:0.26
                                                       green:0.33
                                                        blue:0.48
                                                       alpha:1]];
    ...
    [titleHolder setBackgroundColor : [UIColor colorWithRed:0.20
                                                      green:0.25
                                                       blue:0.33
                                                      alpha:1]];
    
    titleLabel = [[UILabel alloc] initWithFrame : CGRectMake(0, 0, 280, 120)];
    [titleLabel setText:@"操作失败"];
...
//    [cancelButton setTitleColor : [UIColor lightTextColor]
//                       forState : UIControlStateNormal];
...
//    [self.view addSubview:cancelButton];
    ...
    UITapGestureRecognizer *gesture = [[UITapGestureRecognizer alloc] initWithTarget:self
                                                                              action:@selector(nagetiveAction:)];
...
- (void)viewDidAppear:(BOOL)animated
{
    ...
    [self.titleView.layer addAnimation:animation
                                forKey:@"shake"];
}
                ...
                finished:(BOOL)flag
{
    ...
    if (flag == YES)
    {
        ...
        if ([anim isEqual : [self.titleView.layer animationForKey:@"shake"]])
        {
            ...
            [positiveView.layer addAnimation:animation
                                      forKey:@"rotate"];
        ...
        else if([anim isEqual : [positiveView.layer animationForKey:@"rotate"]])
        {
            ...
            [negativeView.layer addAnimation:animation
                                      forKey:@"rotate2"];
        ...
        else if ([anim isEqual : [negativeView.layer animationForKey:@"rotate2"]])
        {
            ...
            [cancelButton.layer addAnimation:rotateAnimation
                                      forKey:@"rotate3"];
