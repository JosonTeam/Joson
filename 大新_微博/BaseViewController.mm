...
{
//    BDVRCustomRecognitonViewController * _audioViewController;
...
//                                             alpha:0];
    ...
    if ([_source[indexPath.section][@"reposts_count"] intValue] > 0)
    {
            
        [button_Name replaceObjectAtIndex:0
                              withObject : [NSString stringWithFormat:@"%d",[_source[indexPath.section][@"reposts_count"] intValue]]];
        
    }

    if ([_source[indexPath.section][@"comments_count"] intValue] > 0)
    {
        
        [button_Name replaceObjectAtIndex:1
                              withObject : [NSString stringWithFormat:@"%d",[_source[indexPath.section][@"comments_count"] intValue]]];
            
    }

    if ([_source[indexPath.section][@"attitudes_count"] intValue] > 0)
    {
            
        [button_Name replaceObjectAtIndex:2
                              withObject : [NSString stringWithFormat:@"%d",[_source[indexPath.section][@"attitudes_count"] intValue]]];
...
didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    weiboDetaile.weiboSource = [MicroBlogOperateForSina getDetaileOfWeiboWithAccessToken:_access_token andId:_source[indexPath.section][@"id"]];
            ...
            switch (index)
            {
                ...
                case 0:
                    ...
                    [MicroBlogOperateForSina createFavoriteWithAccessToken:_access_token
                                                                     andId:JDZ([_source[sender.tag-10][@"id"] integerValue])];
...
#warning ...
                ...
                case 2:
                    ...
                    [MicroBlogOperateForSina destroyWeiBoWithAcccessToken:_access_token
                                                                       iD:JDZ([_source[sender.tag-10][@"id"] integerValue])];
        ...
        tabBar.selectRowAtIndex = ^(NSInteger index)
        {
            ...
            switch (index)
            {
                ...
                case 0:
                    ...
                    [MicroBlogOperateForSina createFavoriteWithAccessToken:_access_token
                                                                     andId:JDZ([_source[sender.tag-10][@"user"][@"id"] integerValue])];
                ...
                case 1:
                    ...
                    [MicroBlogOperateForSina destroyFollowingWithAcccessToken:_access_token
                                                                           iD:JDZ([_source[sender.tag-10][@"user"][@"id"] integerValue])];
            ...
            tabBar.selectRowAtIndex = ^(NSInteger index)
            {
                switch (index)
                {
                    ...
                    case 2:
                        ...
                        [MicroBlogOperateForSina createFavoriteWithAccessToken:_access_token
                                                                         andId:JDZ([_source[indexPath.section][@"id"] integerValue])];
                    ...
                    case 3:
                        ...
                        [MicroBlogOperateForSina destroyWeiBoWithAcccessToken:_access_token
                                                                           iD:JDZ([_source[indexPath.section][@"id"] integerValue])];
...
-(void)clickSection:(UIButton *)sender
{
    ...
    if (sender.tag == 3)
    {
        ...
        NSDictionary * data = [MicroBlogOperateForSina getPicListWithAccessToken:_access_token
                                                                           andId:JDZ([[MicroBlogOperateForSina getIdWithAccessToken:_access_token][@"uid"] integerValue])];
...
//    _audioViewController = tmpAudioViewController;
//    
